function Get-ReportingGroupStatistics
{
    Param(
    ...
    $Path = "/billing-center-api/v2/reporting-groups/$ContractID/products/$ProductID/statistics?fromMonth=$FromMonth&fromYear=$FromYear&toMonth=$ToMonth&toYear=$ToYear&month=$Month&year=$Year&accountSwitchKey=$AccountSwitchKey"
