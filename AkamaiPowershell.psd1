...
FunctionsToExport = 'Activate-APIEndpointVersion', 'Clone-APIEndpoint', 
               ...
               'New-AccessKeyVersion', 'Remove-AccessKeyVersion', 
               'Delete-CachedObjects', 'Invalidate-CachedObjects', 'Purge-Cache', 
               ...
               'Get-SharedCloudletPolicyVersion', 'List-CloudlerLoadBalancers', 
               'List-CloudletAssociatedProperties', 
               'List-CloudletConditionalOrigins', 
               'List-CloudletCurrentLoadBalancingActivations', 
               'List-CloudletGroups', 'List-CloudletLoadBalancingActivations', 
               ...
               'Activate-DataStream', 'Activate-DS1Stream', 'Deactivate-DataStream', 
               'Deactivate-DS1Stream', 'Get-DataStream', 
               'Get-DataStreamActivationHistory', 'Get-DataStreamHistory', 
               'Get-DatastreamMigrationPayload', 'Get-DataStreamVersion', 
               'Get-DS1AggregateLogs', 'Get-DS1RawLogs', 'List-DatastreamConnectors', 
               'List-DatastreamDatasetFields', 'List-DatastreamGroups', 
               'List-DatastreamProducts', 'List-DataStreamProperties', 
               'List-DataStreams', 'List-DataStreamTypes', 
               'List-DS1DatasetParameters', 'List-DS1Groups', 'List-DS1Properties', 
               'List-DS1Streams', 'New-DataStream', 'New-DatastreamMigration', 
               'Remove-DataStream', 'Remove-DS1Stream', 'Set-DataStream', 
               'Set-DS1Stream', 'Get-CurlFromGhostLocation', 
               'Get-DigFromGhostLocation', 'Get-ErrorStringTranslation', 
               'Get-IPCDNStatus', 'Get-IPGeoLocation', 'Get-MtrFromGhostLocation', 
               'List-AvailableGhostLocations', 'Find-IPAddress', 
               'Get-DiagnosticGroupData', 'Get-DiagnosticLink', 
               'Get-EdgeErrorStatistics', 'Get-EdgeLogs', 'Get-ErrorTranslation', 
               'Get-MetadataTrace', 'Get-URLTranslation', 'List-DiagnosticsGroups', 
               'List-EdgeLocations', 'List-IPAccelerationHostnames', 'New-EdgeCurl', 
               ...
               'Add-PropertyHostnames', 'Deactivate-Property', 
               'Deactivate-PropertyInclude', 'Find-Property', 'Get-AccountID', 
               'Get-BulkSearchResults', 'Get-CustomBehavior', 'Get-Group', 
               'Get-GroupByName', 'Get-LatestVersionOfProperty', 
               ...
               'Get-RuleFormatSchema', 'List-AllProperties', 'List-BucketHostnames', 
               ...
               'New-PropertyVersion', 'Remove-BucketHostnames', 'Remove-Property', 
               'Remove-PropertyHostnames', 'Remove-PropertyInclude', 
               'Set-BucketHostnames', 'Set-PAPIClientSettings', 
               'Set-PropertyHostnames', 'Set-PropertyIncludeRuleTemplates', 
               'Set-PropertyIncludeRuleTree', 'Set-PropertyRuleTemplates', 
               'Set-PropertyRuleTree', 'Generate-Report', 'Get-CacheableReport', 
               'Get-ReportType', 'List-ReportTypes', 'List-ReportTypeVersions', 
               'Crypto', 'Decode-Base64String', 'Decode-URL', 'Get-AkamaiCredentials', 
               ...
               'Remove-NullQueryParameters', 'Sanitise-Filename', 
               'Sanitise-QueryString', 'Set-AkamaiSession', 'Test-Auth', 
               ...
               'Get-SPSRequest', 'List-SPSRequests', 'New-SPSEdgeHostname', 
               'New-SPSRequest', 'Activate-TCMSet', 'Get-TCMSet', 
               'Get-TCMSetCertificate', 'Get-TCMSetDeployments', 'Get-TCMSetVersion', 
...
AliasesToExport = 'Get-APIEndpoints', 'Get-APIEndpointVersionResources', 
               ...
               'Get-DataStreamTypes List-DS2StreamTypes', 
               'Get-DS1DatasetParameters', 'Get-DS1Groups', 'Get-DS1Properties', 
               'Get-DS1Streams', 'New-DS2Stream', 'Remove-DS2Stream', 'Set-DS2Stream', 
               'Get-AvailableGhostLocations', 'Get-DiagnosticsGroups', 
               ...
               'Get-BucketHostnames', 'Get-BulkActivatedProperties', 
               'Get-BulkPatchedProperties', 'Get-BulkVersionedProperties', 
               'Get-CustomBehaviors', 'Get-Groups', 'Get-PapiContracts', 
               'Get-PapiCPCodes', 'Get-PapiEdgeHostnames', 'Get-Products', 
               'Get-Properties', 'Get-PropertyActivations', 'Get-PropertyHostnames', 
               'Get-PropertyIncludeActivations', 'Get-PropertyIncludes', 
               'Get-PropertyIncludeVersions', 'Get-PropertyVersions', 
               'Get-RuleFormats', 'Get-TopLevelGroups', 'Get-ReportTypes', 
               'Get-ReportTypeVersions', 'Get-SiteShieldMaps', 
               'Get-SLAAvailabilityReports', 'Get-SLAPerformanceReports', 
               'Get-SLATestAgentGroups', 'Get-SLATestConfigurationQuotas', 
               'Get-SLATestConfigurations', 'Get-SPSRequests', 
               'Get-TCMSetCertificateIDs', 'Get-TCMSetCertificates', 'Get-TCMSets', 
               'Get-TCMSetTrustChains', 'Get-TCMSetVersionCertificateIDs', 
               'Get-TCMSetVersionCertificates', 'Get-TCMSetVersions', 
               'Get-TestCasesInTestSuite', 'Get-TestClientProfiles', 
               'Get-TestClientProfileTestCases', 'Get-TestConditions', 
               'Get-TestConfigVersions', 'Get-TestDefinitions', 'Get-TestExecutions', 
               'Get-TestRequests', 'Get-TestRequestTestCases', 
