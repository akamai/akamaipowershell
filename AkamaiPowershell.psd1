...
FunctionsToExport = 'Activate-APIEndpointVersion', 'Clone-APIEndpoint', 
               ...
               'Set-DS1Stream', 'Find-IPAddress', 'Get-DiagnosticGroupData', 
               'Get-EdgeErrorStatistics', 'Get-EdgeLogs', 'Get-ErrorTranslation', 
               'Get-MetadataTrace', 'Get-URLTranslation', 'List-DiagnosticsGroups', 
               'List-EdgeLocations', 'List-IPAccelerationHostnames', 
               'New-DiagnosticLink', 'New-EdgeCurl', 'New-EdgeDig', 'New-EdgeMTR', 
               'New-ErrorTranslation', 'New-MetadataTrace', 'Test-EdgeIP', 
               'Get-BulkZoneDeleteResult', 'Get-BulkZoneDeleteStatus', 
               'Get-MasterZoneFile', 'Get-RecordSet', 'Get-RecordSetTypes', 'Get-Zone', 
               'Get-ZoneAliases', 'Get-ZoneContract', 'Get-ZoneDNSSecStatus', 
               'Get-ZoneRecordSetNames', 'Get-ZoneRecordSets', 
               'Get-ZoneTransferStatus', 'List-RecordSets', 'List-TSIGKeys', 
               'List-Zones', 'New-BulkZoneDeleteRequest', 'New-MultipleRecordSets', 
               'New-RecordSet', 'New-Zone', 'Remove-RecordSet', 'Set-MasterZoneFile', 
               'Set-MultipleRecordSets', 'Set-RecordSet', 'Set-Zone', 
               'Get-EdgeKVAccessToken', 'Get-EdgeKVGroup', 
...
AliasesToExport = 'Get-APIEndpoints', 'Get-APIEndpointVersionResources', 
               ...
               'Get-DiagnosticsGroups', 'Get-EdgeLocations', 
               'Get-IPAccelerationHostnames', 'Get-RecordSets', 'Get-TSIGKeys', 
               'Get-Zones', 'Remove-Zone', 'Get-EdgeKVAccessTokens', 
