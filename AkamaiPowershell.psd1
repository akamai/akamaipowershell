...
FunctionsToExport = 'Activate-APIEndpointVersion', 'Clone-APIEndpoint', 
               ...
               'Get-DiagnosticLink', 'Get-EdgeErrorStatistics', 'Get-EdgeLogs', 
               'Get-ErrorTranslation', 'Get-MetadataTrace', 'Get-URLTranslation', 
               'List-DiagnosticsGroups', 'List-EdgeLocations', 
               'List-IPAccelerationHostnames', 'New-EdgeCurl', 'New-EdgeDig', 
               'New-EdgeMTR', 'New-ErrorTranslation', 'New-MetadataTrace', 
               'Test-EdgeIP', 'Get-BulkZoneDeleteResult', 'Get-BulkZoneDeleteStatus', 
