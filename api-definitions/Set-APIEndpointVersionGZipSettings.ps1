function Set-APIEndpointVersionGZipSettings
{
    Param(
    ...
    $Path = "/api-definitions/v2/endpoints/$APIEndpointID/versions/$VersionNumber/settings/gzip?accountSwitchKey=$AccountSwitchKey"
