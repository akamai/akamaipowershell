function Get-APIEndpointVersionRoutingSettings
{
    Param(
    ...
    $Path = "/api-definitions/v2/endpoints/$APIEndpointID/versions/$VersionNumber/settings/routing?accountSwitchKey=$AccountSwitchKey"
