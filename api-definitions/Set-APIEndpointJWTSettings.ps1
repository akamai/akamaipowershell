function Set-APIEndpointVersionJWTSettings
{
    Param(
    ...
    $Path = "/api-definitions/v2/endpoints/$APIEndpointID/versions/$VersionNumber/settings/jwt?accountSwitchKey=$AccountSwitchKey"
