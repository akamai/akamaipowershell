function Get-AMDDeliveryData {
    ...
    $Path = "/media-delivery-reports/v1/adaptive-media-delivery/data?startDate=$StartDate&endDate=$EndDate&dimensions=$Dimensions&metrics=$Metrics&aggregation=$Aggregation&limit=$Limit&offset=$Offset&reduce=$ReduceString"
