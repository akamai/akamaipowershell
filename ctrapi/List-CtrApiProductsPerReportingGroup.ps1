function List-CtrApiProductsPerReportingGroup
{
    Param(
    ...
    $Path = "/contract-api/v1/reportingGroups/$ReportingGroupID/products/summaries?from=$From&to=$To&accountSwitchKey=$AccountSwitchKey"
