function Set-AppSecPolicyRuleConditions
{
    Param(
    ...
    process{
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/rules/$RuleID/condition-exception?accountSwitchKey=$AccountSwitchKey"
