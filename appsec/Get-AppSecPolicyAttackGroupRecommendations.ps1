function Get-AppSecPolicyAttackGroupRecommendations
{
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/recommendations/attack-groups/$AttackGroupID`?accountSwitchKey=$AccountSwitchKey"
