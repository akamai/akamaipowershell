function List-AppSecPolicyReputationProfileActions
{
    Param(
    ...
    Write-Host -ForegroundColor Yellow "WARNING: This cmdlet is deprecated and will be removed in a future release. Use List-AppSecPolicyReputationProfiles going forward"
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/reputation-profiles?accountSwitchKey=$AccountSwitchKey"
