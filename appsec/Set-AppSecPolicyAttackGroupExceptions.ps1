function Set-AppSecPolicyAttackGroupExceptions
{
    ...
    process{
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/attack-groups/$AttackGroupID/condition-exception?accountSwitchKey=$AccountSwitchKey"
