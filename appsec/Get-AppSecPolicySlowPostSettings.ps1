function Get-AppSecPolicySlowPostSettings
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/slow-post?accountSwitchKey=$AccountSwitchKey"
