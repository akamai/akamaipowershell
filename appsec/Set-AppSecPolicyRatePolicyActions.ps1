function Set-AppSecPolicyRatePolicyActions
{
    ...
    Write-Host -ForegroundColor Yellow "WARNING: This cmdlet is deprecated and will be removed in a future release. Use Set-AppSecPolicyRatePolicy going forward"
