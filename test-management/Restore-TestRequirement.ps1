function Restore-TestRequirement
{
    ...
    $Path = "/test-management/v2/functional/requirements/$RequirementID/restore?restoreChildResources=$RestoreChildResourcesString&accountSwitchKey=$AccountSwitchKey"
