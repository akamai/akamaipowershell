function List-AppSecPolicyJavascriptInjection
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/javascript-injection?accountSwitchKey=$AccountSwitchKey"
