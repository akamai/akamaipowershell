function Remove-AppSecServeAlternateAction
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/response-actions/serve-alternate-actions/$ActionID`?accountSwitchKey=$AccountSwitchKey"
