function Get-AppSecConfigBotEndpointCoverageReport
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/bot-endpoint-coverage-report?accountSwitchKey=$AccountSwitchKey"
