function List-AppSecPolicyAkamaiBotCategoryActions
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/akamai-bot-category-actions?accountSwitchKey=$AccountSwitchKey"
