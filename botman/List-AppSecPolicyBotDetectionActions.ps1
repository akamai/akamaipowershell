function List-AppSecPolicyBotDetectionActions
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/bot-detection-actions?accountSwitchKey=$AccountSwitchKey"
