function Set-AppSecCustomBotCategorySequence
{
    Param(
    ...
    process{
        ...
        if($Sequence){
            $Body = ConvertTo-Json -Depth 10 $Sequence
        }
    
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/custom-bot-category-sequence?accountSwitchKey=$AccountSwitchKey"
