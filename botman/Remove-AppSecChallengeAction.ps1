function Remove-AppSecChallengeAction
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/response-actions/challenge-actions/$ActionID`?accountSwitchKey=$AccountSwitchKey"
