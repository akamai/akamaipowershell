function List-AppSecChallengeInterceptionRules
{
    Param(
    ...
    $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/response-actions/challenge-interception-rules?accountSwitchKey=$AccountSwitchKey"
